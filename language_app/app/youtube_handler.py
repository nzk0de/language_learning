...
class YouTubeHandler:
    def __init__(self, translator: MYTranslator):
        ...
        self.stanza_pipelines: Dict[str, Pipeline] = {}
    ...
    def _get_transcript_data(
        self, video_id: str, lang_code: str
    ) -> list[Dict[str, Any]]:
        ...
        try:
            ...
            print(
                f"No transcript found for video_id '{video_id}' with lang '{lang_code}'."
            )
    ...
    async def process_video(self, video_id: str, src_lang: str, tgt_lang: str) -> List[Dict[str, Any]]:
        """
        ...
        for chunk in original_chunks:
            string_parts.append(f"\n[{get_times(chunk['start_time'])}-{get_times(chunk['end_time'])}]\n{chunk['text']}")
